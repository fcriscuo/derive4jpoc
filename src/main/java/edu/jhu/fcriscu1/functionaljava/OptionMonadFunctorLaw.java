...
/**
 * Created by fcriscuo on 11/10/15.
 */
public final class OptionMonadFunctorLaw {
    public static void main(final String[] args) {
        final Property unitMap = property(arbOption(arbInteger), Arbitrary.<Integer, String>arbFInvariant(arbString),
                (o, f) -> prop(optionEqual(stringEqual).eq(o.bind(andThen(f, Option.<String>some_())), o.map(f))));
